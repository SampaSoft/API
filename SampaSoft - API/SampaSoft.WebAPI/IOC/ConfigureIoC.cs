...
using SampaSoft.Negocio.Usuarios;
...
namespace SampaSoft.WebAPI.DTO
{
    ...
    public class ConfigureIoC
    {
        ...
        {
            container.RegisterType<SampaSoft.Infraestrutura.EDMX.SampasoftDBEntities>(new HierarchicalLifetimeManager(),
                                            new InjectionFactory(c =>
                                            {
                                                return new SampasoftDBEntities();
                                            })
                                        );
        }
